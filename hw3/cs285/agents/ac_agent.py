...
class ACAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        #     update the critic
        # At the moment i return the average critic and actor loss
        critic_loss = 0
        for i in range(self.agent_params['num_critic_updates_per_agent_update']):
            critic_loss += self.critic.update(ob_no, ac_na, next_ob_no, re_n, terminal_n)
        critic_loss = critic_loss / self.agent_params['num_critic_updates_per_agent_update']
        ...
        actor_loss = actor_loss / self.agent_params['num_actor_updates_per_agent_update']
    ...
    def estimate_advantage(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        q_val = re_n + self.gamma * v_s_prime * np.logical_not(terminal_n)
