...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample,
        ...
        if initial_expertdata and itr == 0:
            ...
            # NOTE: The parallel sampling is currently not transferred to HW4, but it should be possible to directly
            # copy from HW2
            if self.params['use_parallel']:
                paths, envsteps_this_batch = utils.sample_trajectories_parallel_alt(self.env, collect_policy,
